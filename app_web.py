 ...
 # --- ESCENARIO A: ADMINISTRADOR ---
    if rol_actual == "Admin":
        ...
        with tabs[1]:
            ...
            # ==========================================
            # SUB-TAB 2: DIRECTORIO (Solo Lectura)
            # ==========================================
            with sub_tabs[1]:
            ...
            # ==========================================
            # SUB-TAB 3: CONFIGURACIÓN (Con Confirmación de Gol Bot)
            # ==========================================
            with sub_tabs[2]:
